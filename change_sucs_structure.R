...
sucs_data <- sucs_data |>
  correct_faction("Randis IV (Hope IV 2988-)", 
...
sucs_data <- sucs_data |>
  correct_faction("McEvans' Sacrifice", 
...
# contrary
sucs_data <- sucs_data |>
  correct_faction("Gibraltar", "2596", "FWL")
...
# changed to U
sucs_data <- sucs_data |>
  correct_faction("Sherwood", "2596", "U")
...
sucs_data <- sucs_data |>
  correct_faction("Stotzing", "2596", "U")
...
sucs_data <- sucs_data |>
  correct_faction(c("Sigurd", "Oberon VI", "Crellacor"),
...
andurien_3030 <- sucs_data |> 
  ...
  pull(id_mhq)
sucs_data <- sucs_data |>
  correct_faction(andurien_3030, "3030", "FWL")
sucs_data <- sucs_data |> 
  correct_faction(c("Prix", "Primus", "New Roland", "Andarmax", "Jacomarle", 
                    "Drozan", "Renown", "Sax"),
                  c("3030"),
                  "CC")
...
sucs_data <- sucs_data |>
  correct_faction("Star's End (Novo Cressidas)", c("3081", "3085"), "CHH")
...
sucs_data <- sucs_data |>
  correct_faction("Farstar", c("3063", "3067", "3068", "3075"), "I")
...
sucs_data <- sucs_data |>
  correct_faction("Tharkad", c( "3067", "3068"), "LA")
...
# Independents
sucs_data <- sucs_data |>
  correct_faction(c("Santander V (Santander's World)",
...
# Greater Valkyrate
sucs_data <- sucs_data |>
  correct_faction(c("Erewhon", "Lackhove", "Gotterdammerung",
                    "Last Chance", "Botany Bay", "Butte Hold"),
                  "3049",
                  "GV")
# Oberon Confederation
sucs_data <- sucs_data |> 
  correct_faction(c("Placida", "The Rock", "Ferris (OC)", 
...
# Elysian Fields
sucs_data <- sucs_data |>
  correct_faction(c("Manaringaine", "Nyserta", "Elissa", "Porthos"),
                  "3049",
                  "EF")
